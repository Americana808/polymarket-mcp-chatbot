...
interface ChatInputProps {
  ...
  isLoading: boolean;
  inputClassName?: string; // optional override for textarea styling
}

const suggestedActions = [
  {
    title: "Show Bitcoin charts",
    label: "with volume data",
    action:
      "Show Bitcoin markets with a volume chart and recent trading activity.",
  },
  {
    title: "Election comparison",
    label: "probabilities",
    action:
      "Compare probabilities for Trump vs Harris related election markets with a volume chart.",
  },
  {
