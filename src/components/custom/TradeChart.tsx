...
export const TradeChart: React.FC<TradeChartProps> = ({ trades, marketName }) => {
  ...
  return (
    <div className="w-full h-96 p-4 border rounded-lg bg-card">
      <h3 className="text-lg font-semibold mb-4">{marketName} - Recent Trades</h3>
...
export const VolumeChart: React.FC<TradeChartProps> = ({ trades, marketName }) => {
  ...
  return (
    <div className="w-full h-96 p-4 border rounded-lg bg-card">
      <h3 className="text-lg font-semibold mb-4">{marketName} - Trading Volume</h3>
